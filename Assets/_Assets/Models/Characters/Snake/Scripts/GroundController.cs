...
public class GroundController : MonoBehaviour
{
	...
	private IEnumerator CRCreateObjects(int bodyPartAdderNumber, int blockNumber, int obstacleNumber, int coinNumber, bool isCreateShield, bool isCreateMagnet)
	{
		...
		// {
		// 	int index2 = Random.Range(0, listItemPos.Count);
		...
		// {
		// 	int index3 = Random.Range(0, listItemPos.Count);
		...
		// {
		// 	int index4 = Random.Range(0, listItemPos.Count);
		...
		{
			int index5 = Random.Range(0, listBlockPos.Count);
